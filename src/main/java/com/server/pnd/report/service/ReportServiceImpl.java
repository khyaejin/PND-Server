        ...
        try {
            ...
            String prompt =
                    "내가 제공하는 링크로 접속하여 깃 레파지토리 내의 모든 디렉토리 및 코드를 확인해줘. 프로젝트를 전체적으로 리뷰 및 회고를 할 수 있도록 회고 가이드를 생성해줘. 혹시 레포지토리 타이틀이 길어 잘리게 된다면, 폰트 크기는 알아서 조절해줘. 템플릿은 예시 그대로 적용하고 내용만 바꿔주면 돼. 다른 설명할 필요 없이 예시로 제공하는 것처럼 **HTML 문법**을 사용하여 백틱 하나로 감싸진 순수한 문자열만 제공해줘.  \n" +
                            ...
                            "\n" +
                            "<h2>\uD83D\uDCE2 회고 방법 설명</h2>\n" +
                            "<p>4Ls 방식에서는 각 팀원이 위 네 가지 질문에 답변하며, 프로젝트의 성과와 개선점을 도출합니다. 회고를 통해 각자가 배운 점을 나눔으로써 더욱 발전할 수 있습니다.</p>\n" +
                            "\n" +
                            "<h2>\uD83C\uDF08 회고를 위한 기본 요소</h2>\n" +
                            "<ul>\n" +
                            "  <li>\uD83D\uDD05 개방성과 솔직함</li>\n" +
                            ...
                            "\n" +
                            "<h2>\uD83D\uDCA1 프로젝트 개요</h2>\n" +
                            "<p>YourSide-Server는 사용자 데이터 관리 및 추천 시스템을 제공하는 백엔드 프로젝트입니다.</p>\n" +
                            "\n" +
                            "<h2>✅ AI 한줄 평가</h2>\n" +
                            "<h3>\uD83D\uDC4F 잘된 점</h3>\n" +
                            "<ul>\n" +
                            ...
                            "<h3>\uD83D\uDE80 주요 교훈</h3>\n" +
                            "<ul>\n" +
                            "  <li>데이터 최적화: 빠른 응답을 위해 API 개선이 필요합니다.</li>\n" +
                            "</ul>\n" +
                            "\n" +
                            "<h3>\uD83D\uDCA1 회고하면 좋을 것들</h3>\n" +
                            "<ul>\n" +
                            ...
                            "\n" +
                            "<h2>\uD83D\uDCE2 회고 방법 설명</h2>\n" +
                            "<p>CSS 방식은 팀원들이 각 항목에 대해 나눠 토론하며 유지해야 할 점과 중단할 점을 정리하고, 새로 시도할 항목을 계획합니다.</p>\n" +
                            "\n" +
                            "<h2>\uD83C\uDF08 회고를 위한 기본 요소</h2>\n" +
                            "<ul>\n" +
                            "  <li>\uD83D\uDD05 개방성과 솔직함</li>\n" +
                            ...
                            "\n" +
                            "<h2>\uD83D\uDCA1 프로젝트 개요</h2>\n" +
                            "<p>Scapture 서버는 사용자 데이터 처리 및 이미지 분석 기능을 지원하는 백엔드 프로젝트입니다.</p>\n" +
                            "\n" +
                            "<h2>✅ AI 한줄 평가</h2>\n" +
                            "<h3>\uD83D\uDC4F 잘된 점</h3>\n" +
                            "<ul>\n" +
                            ...
                            "<h3>\uD83D\uDE80 주요 교훈</h3>\n" +
                            "<ul>\n" +
                            "  <li>확장성의 중요성: 확장 가능성을 고려한 설계의 필요성을 배웠습니다.</li>\n" +
                            "</ul>\n" +
                            "\n" +
                            "<h3>\uD83D\uDCA1 회고하면 좋을 것들</h3>\n" +
                            "<ul>\n" +
